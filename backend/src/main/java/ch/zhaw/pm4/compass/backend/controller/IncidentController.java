...
public class IncidentController {
	...
	public ResponseEntity<List<IncidentDto>> getAllIncidentsByParticipant(@PathVariable String userId) {
		return ResponseEntity.ok(incidentService.getAllIncidentByUser(userId));
	}
}
