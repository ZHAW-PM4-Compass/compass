...
/**
 * Controller for managing ratings within the Compass application. Provides
 * RESTful endpoints for creating and recording ratings related to day sheets
 * and categories.
 *
...
public class RatingController {
	 ...
	 * @return ResponseEntity with the created RatingDto or BAD_REQUEST if the
	 *         rating is not valid.
	 * @throws RatingIsNotValidException if the rating criteria are not met.
	 * @throws CategoryNotFoundException if the category related to the rating does
	 *                                   not exist.
	 * @throws DaySheetNotFoundException if the day sheet related to the rating does
	 *                                   not exist.
	 */
	 ...
	 *                        credentials.
	 * @return ResponseEntity with a list of recorded RatingDto or appropriate error
	 *         status.
	 * @throws TooManyRatingsPerCategoryException if there are too many ratings for
	 *                                            a single category.
	 * @throws UserNotOwnerOfDaySheetException    if the user does not own the day
	 *                                            sheet.
	 */
	...
	/**
	 * Records multiple ratings related to a specific day sheet for the
	 * authenticated user.
	 *
	 * @param daySheetId      The day sheet ID where the ratings will be recorded.
	 * @param categoryDtoList List of category DTOs related to the ratings.
