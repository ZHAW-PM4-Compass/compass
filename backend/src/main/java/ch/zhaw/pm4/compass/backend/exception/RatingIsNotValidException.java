...
/**
 * Custom exception thrown when a rating value does not comply with the
 * predefined limits set for a category. This exception ensures that rating
 * values are validated against category-specific constraints, helping maintain
...
public class RatingIsNotValidException extends Exception {
	...
	/**
	 * Constructs a new RatingIsNotValidException with detailed information about
