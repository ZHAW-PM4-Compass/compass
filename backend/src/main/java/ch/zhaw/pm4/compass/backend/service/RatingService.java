...
public class RatingService {
  ...
  /**
   * Retrieves all ratings for a specific date. Optionally, ratings can also be filtered by user ID.
   * The method returns a list of extended rating DTOs, which include the participant's name.
   * 
